...
const updateActors = (data_movie) => {
	data_movie.clear();
	actorsModel.addActors(data_movie.req)
	data_movie.res = actorsModel.getActorsById(data_movie.req.id).actors;
}
const listMovies = (data_movie) => {
	data_movie.clear();
	data_movie.res=actorsModel.listMovies(data_movie.req)
}
